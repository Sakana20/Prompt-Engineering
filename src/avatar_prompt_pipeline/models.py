...
class IssueCode(StrEnum):
    ...
    COPY_MODE_RATIO_MISMATCH = "COPY_MODE_RATIO_MISMATCH"
    MISSING_SOURCE_BLOCK_ID = "MISSING_SOURCE_BLOCK_ID"
    DUPLICATE_SOURCE_BLOCK = "DUPLICATE_SOURCE_BLOCK"
    INVALID_REWRITE_ANCHORS = "INVALID_REWRITE_ANCHORS"
    SOURCE_BLOCK_INCOMPATIBLE = "SOURCE_BLOCK_INCOMPATIBLE"
    INVALID_SOURCE_BINDINGS = "INVALID_SOURCE_BINDINGS"
    CAMPAIGN_IN_PRODUCT_SLOT = "CAMPAIGN_IN_PRODUCT_SLOT"
    PRODUCT_LOGIC_MISMATCH = "PRODUCT_LOGIC_MISMATCH"
    UNEXPECTED_SOURCE_METADATA = "UNEXPECTED_SOURCE_METADATA"
    ...
    COPY_TAG_CONCENTRATION = "COPY_TAG_CONCENTRATION"
    PERSON_TAG_CONCENTRATION = "PERSON_TAG_CONCENTRATION"
    OUTFIT_TAG_CONCENTRATION = "OUTFIT_TAG_CONCENTRATION"
    DUPLICATE_PERSON = "DUPLICATE_PERSON"
    DUPLICATE_OUTFIT = "DUPLICATE_OUTFIT"
    MISSING_EYE_CONTACT = "MISSING_EYE_CONTACT"
    MISSING_NO_HANDHELD_PRODUCT = "MISSING_NO_HANDHELD_PRODUCT"
    HANDHELD_PRODUCT = "HANDHELD_PRODUCT"
    PROHIBITED_BODY_ACTION = "PROHIBITED_BODY_ACTION"
    MISSING_LOGO_SCOPE = "MISSING_LOGO_SCOPE"
    PROHIBITED_NON_PRODUCT_LOGO = "PROHIBITED_NON_PRODUCT_LOGO"
    MISSING_NO_SUBTITLES = "MISSING_NO_SUBTITLES"
    PROHIBITED_SUBTITLES = "PROHIBITED_SUBTITLES"
    VISUAL_PROMPT_TOO_LONG = "VISUAL_PROMPT_TOO_LONG"
    VISUAL_PROMPT_TOO_SHORT = "VISUAL_PROMPT_TOO_SHORT"
    MISSING_FRONTLOADED_FRAME_STYLE = "MISSING_FRONTLOADED_FRAME_STYLE"
    MISSING_PERSON_FRAME_RATIO = "MISSING_PERSON_FRAME_RATIO"
    MISSING_FRONT_TABLE_PRODUCT_PLACEMENT = "MISSING_FRONT_TABLE_PRODUCT_PLACEMENT"
    PROHIBITED_BEHIND_PRODUCT_PLACEMENT = "PROHIBITED_BEHIND_PRODUCT_PLACEMENT"
    MISSING_TALKING_HEAD_FRAME = "MISSING_TALKING_HEAD_FRAME"
    MISSING_BACKGROUND_ONLY_SCENE = "MISSING_BACKGROUND_ONLY_SCENE"
    PROHIBITED_BLANK_WHITE_WALL = "PROHIBITED_BLANK_WHITE_WALL"
    MISSING_NO_PRODUCT_GAZE_OR_CONTACT = "MISSING_NO_PRODUCT_GAZE_OR_CONTACT"
    MISSING_PERSON_DEMOGRAPHIC = "MISSING_PERSON_DEMOGRAPHIC"
    PROHIBITED_PERSON_STYLE = "PROHIBITED_PERSON_STYLE"
